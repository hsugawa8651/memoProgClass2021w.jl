...
[Allowed Variable Names (section)](https://docs.julialang.org/en/v1.6/manual/variables/#Allowed-Variable-Names)
...
[Stylistic Conventions (section)](https://docs.julialang.org/en/v1.6/manual/variables/#Stylistic-Conventions)
